...
10. ***Left-Invariant Riemannian Geodesics on Spatial Transformation Groups.***
...
9. ***Multivariate Tensor-Based Morphometry with a Right-Invariant Riemannian Distance on GL+(n).***
...
8. ***Brain Regions Related to Fear Extinction in Obsessive-Compulsive Disorder and its Relation to Exposure Therapy Outcome: a Morphometric Study.***
...
7. ***Modeling and Quantification of Repolarization Feature Dependency on Heart Rate.***
...
5. ***Statistical Analysis of Relative Pose Information of Subcortical Nuclei: Application on ADNI Data.***
...
3. ***3D Edge Detection by Selection of Level Surface Patches.***
...
2. ***Transferring the Rig and Animations from a Character to Different Face Models.***
